...
<head>
    ...
    <title>Our Strategy - At Perfect Gateway, we specialize in mobile application and website development</title>
                    ...
                    <div class="choose-us-content-wrap">
                        <div class="row">
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    ...
                                    <div class="choose-us-content">
                                        <h3 class="title"><a href="#">Discovery</a></h3>
                                        <p>Create what? For whom? What happens? We'll ask these questions. To create a great practical product, your ideas must be precise and unambiguous. Don't worry—we'll help. We solve digital issues.</p>
                                    </div>
                                </div>
                                <!-- Choose Us Item End -->
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    <div class="choose-us-img">
                                        <img src="assets/images/practice.svg" alt="">
                                    </div>
                                    <div class="choose-us-content">
                                        <h3 class="title"><a href="#">Design</a></h3>
                                        <p>Project visuals begin here. We start with sitemaps, then wireframes, and sketches using your planned information. We'll add color and photographs after the layout is set. Mockups are reviewed, tweaked, and approved until both sides are pleased.</p>
                                    </div>
                                </div>
                                <!-- Choose Us Item End -->
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    <div class="choose-us-img">
                                        <img src="assets/images/beauty.svg" alt="">
                                    </div>
                                    <div class="choose-us-content">
                                        <h3 class="title"><a href="#">Develop</a></h3>
                                        <p>Your project comes alive here. We'll build your CMS. This method varies by client, program, and server constraints. We guarantee compatibility with current and older browsers.</p>
                                    </div>
                                </div>
                                <!-- Choose Us Item End -->
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="skill-left">
                               ...
                               <h4>We Provide a 100% customer satisfaction guarantee and will work until you are satisfied.</h4>
                               </div>
                            </div>
                            <!-- Skill Left End -->
                        </div>
...
<!-- Mirrored from thepixelcurve.com/html/techwix/techwix/choose-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 11:49:03 GMT -->
</html>