          ...
          <div class="row align-items-center">
            <div class="col-lg-5">
              ...
              <h3 class="sub-title" data-aos-delay="600" data-aos="fade-up">
                  <span>HOT !</span>oneportal
                </h3>
                <h2 class="title" data-aos="fade-up" data-aos-delay="800">
                Assisting schools to go digital.
                </h2>
                <p data-aos="fade-up" data-aos-delay="900">
                Delivering a remote learning environment, flexible result compilation system, computer-based test environment
                </p>
          ...
          <div class="about-wrap">
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="testimonial-img" style="margin-top:40px;">
                  <img src="assets/images/innovatrix/32.jpg" alt="" />
                </div>
                </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="about-list">
                    <p>Oneportal is a school management portal that brings together students, parents, instructors, and management to help schools go digital. Providing remote learning, customizable result compilation, computer-based testing, and student and staff profile management.
                    </p>
                    <h5>Features</h5>
                  <ul>
                      <li>
                  ...
                  <a class="btn" style="padding:0px 8px" href="https://www.oneportal.ng">START</a>
