...
<head>
    ...
    <title>Contact Us - At Perfect Gateway, we specialize in mobile application and website development</title>
...
<script type="text/javascript">
   (function(){
      emailjs.init("To6IyqiCtby2zNq9M");
   })();
</script>
...
<body>
    ...
    <div class="main-wrapper">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="single-contact-info text-center">
                                ...
                                <div class="info-content">
                                    ...
                                    <p>info@perfectgateway.com.ng</p>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="single-contact-info text-center">
                                ...
                                <div class="info-content">
                                    ...
                                    <p>33 Democracy Crescent,Gaduwa Estate,Gudu.Abuja</p>
                                </div>
                            </div>
                            <!--Single Contact Info End -->
                        </div>
                            ...
                            <div class="contact-form">
                                <div class="contact-form-wrap">
                                    <div class="heading-wrap text-center">
                                        ...
                                        <h3 class="title" style="color:#db19a1;">How May We Help You!</h3>
                                    </div>
                                    <form action="#">
                                        <div class="row">
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-12">
                                                <!--  Single Form Start -->
                                                <div class="form-btn">
                                                    <button class="btn" type="submit" onclick="sendMail()">Send Message</button>
                                                </div>
                                                <!--  Single Form End -->
                                            </div>
                                        </div>
        ...
        <div class="section contact-map-section">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3940.6964076603795!2d7.465393974013745!3d9.000057689443398!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x104e877db1e8279b%3A0x1061a1ce3b4f2d1!2sJamasoft%20Concept%20Ltd!5e0!3m2!1sen!2sng!4v1686066024274!5m2!1sen!2sng" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>            </div>
        </div>
        <!-- Contact Map End -->
...
<!-- Mirrored from thepixelcurve.com/html/techwix/techwix/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 11:49:24 GMT -->
</html>